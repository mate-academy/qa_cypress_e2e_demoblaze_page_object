import HomeAndCataloguePageObject from
  '../support/pages/homeСatalogue.pageObject.js';
import ProductPageObject from '../support/pages/placeOrderForm.pageObject.js';
...
const testData = {
  ...
  year: faker.datatype.number({ min: 2024, max: 2035 })
};
